...
class MyFrame
    ...
    public MyFrame()
    {
        setTitle("Visa Registration Form");
    ...
    public void actionPerformed(ActionEvent e)
    {
        if (e.getSource() == sub) {
            if (term.isSelected()) {
                ...
                String result = tname.getText() + " " + password + " " + tmno.getText() + " " + data1 + " "+(String)date.getSelectedItem() + "/"+ (String)month.getSelectedItem()+"/"+(String)year.getSelectedItem() + "\n";
                try{
                    ...
                    dispose();
                    LoginFrame frame100 = new LoginFrame();
